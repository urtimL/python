...
# list2 = "пара-ра-рам рам-пам-папам па-ра-па-да-ра".split()

# vowels = ["а","о","у"]

# listVowel = list(map(lambda x: list(filter(lambda y: y in vowels, x)), list1))
# countRez = list(filter(lambda x: len(x) != len(listVowel[0]), listVowel))

# print("Парам пам-пам" if len(countRez) == 0 else "Пам парам")
